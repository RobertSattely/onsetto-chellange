...
class Logger:
    ...
    def info(message):
        ...
        print(
            f"[{datetime.now():%Y-%m-%d %H:%M:%S}] [INFO]  {message}"
        )
    ...
    def success(message):
        ...
        print(
            f"[{datetime.now():%Y-%m-%d %H:%M:%S}] [PASS]  {message}"
        )
    ...
    def warning(message):
        ...
        print(
            f"[{datetime.now():%Y-%m-%d %H:%M:%S}] [WARN]  {message}"
        )
    ...
    def error(message):
        ...
        print(
            f"[{datetime.now():%Y-%m-%d %H:%M:%S}] [FAIL]  {message}"
        )
